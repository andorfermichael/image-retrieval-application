...
(function (factory) {
    ...
    tFooter = '<div class="file-thumbnail-footer">\n' +
        '    <div id="file-footer-caption" class="file-footer-caption" title="{caption}">{caption}{size}</div>\n' +
        '    {progress} {actions}\n' +
        '</div>';
    ...
    tActionUpload = '<button type="button" id="{uploadID} "class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
        '{uploadIcon}</button>';
    ...
    tImage = '<img src="{data}" id="file-preview-image" class="kv-preview-data file-preview-image" title="{caption}" alt="{caption}" ' +
        STYLE_SETTING + '>\n';
    ...
    FileInput.prototype = {
        ...
        _renderButton: function (type) {
            var self = this, tmplt = self._getLayoutTemplate('btnDefault'), id = self[type + 'ID'], css = self[type + 'Class'],
            ...
            return tmplt.replace('{type}', btnType).replace('{id}', id).replace('{css}', css).replace('{title}', title)
        ...
        _renderFileActions: function (showUpload, showDelete, showZoom, showDrag, disabled, url, key, isInit) {
            ...
            if (showDelete) {
                btnDelete = self._getLayoutTemplate('actionDelete')
					.replace(/\{removeID}/g, config.removeID)
